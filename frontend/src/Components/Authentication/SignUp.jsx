    ...
    <>
      <div className='border-2 flex justify-center w-[80vw] md:w-[70vw] lg:w-[100%] border-black bg-gradient-to-bl from-blue-100 items-center to-red-100  h-[70vh] md:px-20 py-10 rounded-xl'>
        <div className='flex flex-col space-y-6 lg:w-[25vw]'>
          <span className='text-center mb-10 font-semibold text-3xl' style={{ fontFamily: 'sans-serif' }}>Create Account</span>
          ...
          <div className='text-center font-medium' style={{ fontFamily: 'sans-serif' }}>Already have an account? <span className='text-red-600 font-medium text-lg'>Sign In</span></div>
        </div>
      </div>
    </>
  )
